    ...
    return (
        <>
            <div className="md:hidden flex items-center justify-between">
                ...
                <button className="flex items-center gap-1 bg-zomato-400 px-3 py-1 rounded-lg">
        ...
        <>
            <div className="hidden md:flex items-center justify-between container px-20 mx-auto">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button className="flex items-center text-lg h-10 font-light  gap-1 bg-zomato-400 px-3 py-1 rounded-lg">
                        Continue <IoMdArrowDropright />
                    </button>
                </div>
            </div>
...
const CartContainer = () => {
    ...
    return (
        <>
            {
                isOpen && (
                    <div className="fixed w-full overflow-y-scroll h-48 bg-white z-10 p-2 bottom-2 px-3">
